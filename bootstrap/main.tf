resource "azurerm_resource_group" "rg-pls-dev" {
...
resource "azurerm_storage_account" "tfstatestorageact" {
  ...
  resource_group_name      = azurerm_resource_group.rg-pls-dev.name
  location                 = azurerm_resource_group.rg-pls-dev.location
